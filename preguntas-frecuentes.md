...
Diariamente recibo mensajes y comentarios (en su mayoría, a través de las redes sociales y el canal de Youtube) que intento responder pero, en muchos casos esto se me hace imposible por cuestiones de tiempo. Por eso, en esta página intentaré dar respuesta a las preguntas más comunes.
...
**¿Qué consejos podrías darme sobre cómo empezar a programar**
Varios de estos consejos los comenté en [esta entrevista](https://youtu.be/7I8k2Y5_hXQ){:target="_blank"} que me hicieron para el canal amigo "Curso de robótica".
...
La respuesta a esa pregunta necesita un análisis cuidadoso de la arquitectura del proyecto y el "stack tecnológico" necesario. Pero [esta publicación]({{ site.baseurl }}{% link _posts/2019-11-01-que-lenguaje-usar.md %}){:target="_blank"} podría servir como guía introductoria.
...
**¿Quiénes están detrás de Programación Desde Cero?**
Principalmente yo, Patricia. 🙂 Aunque siempre estoy recibiendo ayuda de amigos, colegas y ex-compañeros de universidad y laborales, a los que recurro para consultar cuestiones específicas acerca de las que ellos saben más y tienen experiencia.
...
**¿Quién sos, de dónde sos, qué edad tenés?**
